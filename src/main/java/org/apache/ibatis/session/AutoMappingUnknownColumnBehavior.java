...
public enum AutoMappingUnknownColumnBehavior {
  ...
  private static String buildMessage(MappedStatement mappedStatement, String columnName, String property,
      Class<?> propertyType) {
    return "Unknown column is detected on '" + mappedStatement.getId() +
      "' auto-mapping. Mapping parameters are " + "[" + "columnName=" + columnName +
      "," + "propertyName=" + property + "," + "propertyType=" +
      (propertyType != null ? propertyType.getName() : null) + "]";
  }
